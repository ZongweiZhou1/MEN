...
class RoIAlign(nn.Module):
    ...
    def __init__(self, crop_height, crop_width, featstride=1.0, extrapolation_value=0, transform_fpcoor=True):
    ...
    def forward(self, featuremap, boxes, box_ind):
        ...
        :return: MxCxoHxoW
        """
        x1, y1, x2, y2 = torch.split(boxes/torch.tensor(self.featstride).cuda(boxes.device), 1, dim=1)
